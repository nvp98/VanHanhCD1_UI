...
const BM_NoiHoiOngKhoiThieuKet2: React.FC = () => {
    const baseURL = import.meta.env.VITE_API_BASE_URL;
    const apiURL = baseURL + "/api/NoiHoiOngKhoiHai";
    ...
    const handleExportExcel = async () => {
       if (!fromDate || !toDate) {
        ...
        try {
            ...
            link.href = url;
            link.download = `BM.01/HD.05.60-19_NKVH_NoiHoiOngKhoLamMatVong2_${fromStr}_đến_${toStr}.xlsx`;
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            Nhật ký vận hành Nồi Hơi Ống Khói Và Quạt Gió Làm Mát Vòng #2
                        </h1>
...
export default BM_NoiHoiOngKhoiThieuKet2;