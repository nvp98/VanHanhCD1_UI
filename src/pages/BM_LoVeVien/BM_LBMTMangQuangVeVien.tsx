...
const BM_LBMTMangQuangVeVien: React.FC = () => {
                ...
                <div className="border rounded-xl overflow-x-auto max-w-full  max-h-[60vh]">
                    <table className="min-w-full table-auto text-sm border-collapse border border-gray-300 bg-white">
                        ...
                        <tbody className="text-gray-800 even:bg-gray-50">
                            {renderNestedRows(sectionPhoiLieuRowData, "Máng quặng thành phẩm", 14)}
                            {renderNestedRows(sectionBanLuocRowData, "Trạm trung chuyển 2 3", 15)}
                        </tbody>
                    </table>
                </div>
            </div>
...
export default BM_LBMTMangQuangVeVien;