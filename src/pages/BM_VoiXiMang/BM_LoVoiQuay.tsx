...
const sectionRowData: SectionType[] = [
    {
        section: "Bộ dự nhiệt",
        rows: [
            { label: "Mức liệu đo ở silo liệu" },
            { label: "Lượng đẩy vào", children: ["Thiết lập sản lượng ngày", "Thiết lập lượng đẩy vào"] },
            { label: "Áp suất", children: ["Áp đuôi lò"] },
            { label: "Nhiệt độ", children: ["Đuôi lò", "Phần đỉnh bộ dự nhiệt"] },
        ],
    },
    {
        section: "Hệ thống đốt",
        rows: [
            { label: "Quạt trợ đốt", children: ["Lưu lượng", "Dòng điện", "Tần số"] },
            { label: "Quạt thổi bột than", children: ["Lưu lượng", "Dòng điện", "Tần số"] },
            { label: "Cân rotor bột than", children: ["Khối lượng"] },
        ],
    },
    {
        section: "Lò quay",
        rows: [
            ...
            { label: "Áp đầu lò" },
            { label: "Nhiệt độ ngọn lửa" },
            { label: "Dòng điện động cơ chính" },
        ],
    },
    {
        section: "Bộ lọc bụi khí thải",
        rows: [
            { label: "Áp suất", children: ["Đầu vào", "Đầu ra", "Chênh áp"] },
            { label: "Áp suất", children: ["Áp đuôi lò"] },
            { label: "Nhiệt độ", children: ["Lối vào", "Lối ra"] },
        ],
    },
    {
        section: "Quạt khí thải",
        rows: [
            { label: "Dòng điện" },
            { label: "Tần số" },
        ],
    },
     {
        section: "Bộ làm mát",
        rows: [
            { label: "Quạt làm mát", children: ["Lưu lượng", "Dòng điện", "Tần số"] },
            { label: "Nhiệt độ sản phẩm (đo tại cấp liệu rung)", children: ["1","2","3","4"] },
        ],
    },
]


const BM_LoVoiQuay: React.FC = () => {
    const baseURL = import.meta.env.VITE_API_BASE_URL;
    const apiURL = baseURL + "/api/LoVoiQuay";
    ...
    const handleExportExcel = async () => {
        ...
        try {
            ...
            link.href = url;
            link.download = `BM.01/HD.05.53-19_NKVH_VoiDungQuay_${fromStr}_đến_${toStr}.xlsx`;
