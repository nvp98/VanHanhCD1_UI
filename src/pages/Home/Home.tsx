...
const { backgroundHome, cardOne, cardTwo } = images;
...
const Home = () => {
  ...
  return (
    <div className="theme-swiss sm:m-6 space-y-6 px-6">
      <div className=" relative bg-skin-fill overflow-hidden sm:rounded-2xl">
        ...
        <div className="relative mx-auto text-start py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-skin-muted">
            Hòa Phát là Tập đoàn sản xuất công nghiệp hàng đầu Việt Nam. Khởi
            ...
            {factories.map((item, index) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                  <h3 className="text-skin-base font-semibold text-lg">
                    {item.name}
                  </h3>
                </div>
              </div>
      ...
      <hr className="my-12 h-px border-t-2 bg-transparent bg-gradient-to-r from-transparent via-neutral-600 to-transparent  dark:via-neutral-500" />
          ...
          <div className="flex gap-[5px] flex-col">
            ...
            <div className="w-full">
              ...
              <p className="mt-4 text-lg leading-6 ">
                Nhà máy Cơ điện 1 là đơn vị thực hiện công tác bảo trì; sửa
                chữa, lắp đặt, gia công; hiệu chuẩn, kiểm định cho cụm thiết bị
                Nhà máy Nguyên liệu, Nhà máy Thiêu kết - Vê viên, Nhà máy Luyện
                cốc, Bộ phận Cảng và Công ty Cổ phần Cảng tổng hợp Hòa Phát được
                hoạt động.Đảm bảo, tăng cường tính sẵn sàng thiết bị, nâng cao
                tuổi thọ của thiết bị trong quá trình sử dụng và hạn chế những
                sự cố rủi ro thiết bị gây ra.Đảm bảo phục vụ sản xuất an toàn,
                vệ sinh môi trường, tiết kiệm và đạt hiệu quả cao nhất ổn định,
                đảm bảo sản xuất
              </p>
            </div>
            <div className="sm:flex sm:justify-start mt-3">
              <div className="space-y-4 sm:space-y-0 sm:inline-grid  sm:gap-5">
                <a
                  href="#"
                  className="text-cyan-50 bg-skin-button-accent hover:bg-skin-button-accent-hover flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm sm:px-8"
                >
                  {" "}
                  Xem biểu mẫu{" "}
                </a>
