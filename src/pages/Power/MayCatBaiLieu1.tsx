...
import { MAYCAT_BAILIEU1_CONFIG, MAYCAT_BAILIEU1_SECTION } from "../../config/TuDienNguyenLieuConfig";
...
const MayCatBaiLieuMot: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        MAYCAT_BAILIEU1_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            Tủ Máy Cắt Liên Lạc Bãi Liệu 1
                        </h1>
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={MAYCAT_BAILIEU1_CONFIG}
                />}
...
export default MayCatBaiLieuMot;