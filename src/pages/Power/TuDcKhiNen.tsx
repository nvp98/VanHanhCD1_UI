...
import { TUDC_KHINEN_CONFIG, TUDC_KHINEN_SECTION } from "../../config/TuDienNguyenLieuConfig";
...
const TuDCKhiNen: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        TUDC_KHINEN_SECTION.forEach(sec => {
