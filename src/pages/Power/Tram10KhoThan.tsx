...
import { MBA10KV_KHOTHAN_CONFIG, MBA10KV_KHOTHAN_SECTION } from "../../config/MBANguyenLieuConfig";
...
const Tram10KhoThan: React.FC = () => {
    const baseURL = import.meta.env.VITE_API_BASE_URL;
    const apiURL = baseURL + "/api/MBABaiLieu";
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        MBA10KV_KHOTHAN_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={MBA10KV_KHOTHAN_CONFIG}
                />}
