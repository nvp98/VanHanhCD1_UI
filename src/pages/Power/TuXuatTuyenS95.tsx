...
import { TUXUAT_S95_CONFIG, TUXUAT_S95_SECTION } from "../../config/TuDienNguyenLieuConfig";
...
const TuXuatTuyenS95: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        TUXUAT_S95_SECTION.forEach(sec => {
