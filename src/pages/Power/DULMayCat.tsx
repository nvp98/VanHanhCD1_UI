...
import { TUMAYCAT_MBA_CONFIG,  TUMAYCAT_MBA_SECTION} from "../../config/TramDienDULconfig";
...
const MayCatDUL: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        TUMAYCAT_MBA_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={TUMAYCAT_MBA_CONFIG}
                />}
