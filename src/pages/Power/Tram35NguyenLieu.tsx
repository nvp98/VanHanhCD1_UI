...
import { MBA35KV_NMNL_CONFIG, MBA35KV_NMNL_SECTION } from "../../config/MBANguyenLieuConfig";
...
const Tram35NguyenLieu: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        MBA35KV_NMNL_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            MBA 35/10kV 31.5MVA Trạm 35kV NM.NL
                        </h1>
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={MBA35KV_NMNL_CONFIG}
                />}
...
export default Tram35NguyenLieu;