...
import { TUDIEN_DAUVAO_BAILIEU2_CONFIG, TUDIEN_DAUVAO_BAILIEU2_SECTION } from "../../config/TuDienNguyenLieuConfig";
...
const TuDienBaiLieuHai: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        TUDIEN_DAUVAO_BAILIEU2_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={TUDIEN_DAUVAO_BAILIEU2_CONFIG}
                />}
...
export default TuDienBaiLieuHai;