...
import { TUDIEN_DAUVAO_BAILIEU1_CONFIG, TUDIEN_DAUVAO_BAILIEU1_SECTION } from "../../config/TuDienNguyenLieuConfig";
...
const TuDienBaiLieuMot: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        TUDIEN_DAUVAO_BAILIEU1_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={TUDIEN_DAUVAO_BAILIEU1_CONFIG}
                />}
...
export default TuDienBaiLieuMot;