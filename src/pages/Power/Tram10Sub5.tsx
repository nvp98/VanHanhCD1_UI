...
import { MBA10KV_SUB5_CONFIG, MBA10KV_SUB5_SECTION } from "../../config/MBANguyenLieuConfig";
...
const Tram10Sub5: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        MBA10KV_SUB5_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={MBA10KV_SUB5_CONFIG}
                />}
