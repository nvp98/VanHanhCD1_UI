...
import { TUDAUVAO_10KV_CONFIG,  TUDAUVAO_10KV_SECTION} from "../../config/TramDienDULconfig";
...
const TuDauVao10kVDUL: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        TUDAUVAO_10KV_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={TUDAUVAO_10KV_CONFIG}
                />}
...
export default TuDauVao10kVDUL;