...
import { MBA_TIEPDIA_CONFIG,  MBA_TIEPDIA_SECTION } from "../../config/TramDienThieuKetVeVienConfig";
...
const TiepDiaMBAThieuKetVeVien: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        MBA_TIEPDIA_SECTION.forEach(sec => {
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                           MBA Tiếp Địa Trạm 35kV Thiêu Kết Vê Viên
                        </h1>
...
export default TiepDiaMBAThieuKetVeVien;