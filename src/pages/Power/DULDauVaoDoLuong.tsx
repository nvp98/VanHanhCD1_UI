...
import { TUDOLUONGDAUVAO_35KV_CONFIG,  TUDOLUONGDAUVAO_35KV_SECTION} from "../../config/TramDienDULconfig";
...
const TuDauVaoDoLuongDUL: React.FC = () => {
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            Tủ Đo Lường Đầu Vào 35kV Và Tủ Liên Lạc DUL
                        </h1>
...
export default TuDauVaoDoLuongDUL;