...
import { MAYCAT_BAILIEU2_CONFIG, MAYCAT_BAILIEU2_SECTION } from "../../config/TuDienNguyenLieuConfig";
...
const MayCatBaiLieuHai: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        MAYCAT_BAILIEU2_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={MAYCAT_BAILIEU2_CONFIG}
                />}
...
export default MayCatBaiLieuHai;