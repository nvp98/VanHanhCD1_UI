...
import { TUDOLUONGDAUVAO_35KV_CONFIG, TUDOLUONGDAUVAO_35KV_SECTION } from "../../config/TramDienThieuKetVeVienConfig";
...
const TuDoLuong35kVThieuKetVeVien: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        TUDOLUONGDAUVAO_35KV_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            Tủ Đo Lường Đầu Vào 35kV Thiêu Kết Vê Viên
                        </h1>
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={TUDOLUONGDAUVAO_35KV_CONFIG}
                />}
...
export default TuDoLuong35kVThieuKetVeVien;