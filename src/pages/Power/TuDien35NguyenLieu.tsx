...
import { TUDIEN35KV_NMNL_CONFIG, TUDIEN35KV_NMNL_SECTION } from "../../config/TuDienNguyenLieuConfig";
...
const TuDien35NguyenLieu: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        TUDIEN35KV_NMNL_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            Tủ đầu vào phía 10kV MBA 35/10kV 31.5MVA NM.NL
                        </h1>
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={TUDIEN35KV_NMNL_CONFIG}
                />}
...
export default TuDien35NguyenLieu;