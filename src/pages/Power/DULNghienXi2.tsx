...
import { NGHIENXI2_35KV_CONFIG,  NGHIENXI2_35KV_SECTION} from "../../config/TramDienDULconfig";
...
const TuNghienXi2DUL: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        NGHIENXI2_35KV_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            Tủ Điện Nghiền Xỉ 2 Trạm Điện 35kV DUL
                        </h1>
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={NGHIENXI2_35KV_CONFIG}
                />}
