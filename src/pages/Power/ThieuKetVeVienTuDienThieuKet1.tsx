...
import { TRAMDIEN35KV_THIEUKET1_CONFIG,  TRAMDIEN35KV_THIEUKET1_SECTION } from "../../config/TramDienThieuKetVeVienConfig";
...
const TuDienThieuKet1: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        TRAMDIEN35KV_THIEUKET1_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                           Tủ Điện Thiêu Kết 1 Trạm 35kV Thiêu Kết Vê Viên
                        </h1>
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={TRAMDIEN35KV_THIEUKET1_CONFIG}
                />}
...
export default TuDienThieuKet1;