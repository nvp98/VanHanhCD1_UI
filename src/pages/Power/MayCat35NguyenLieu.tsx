...
import { MAYCAT_35KV_CONFIG, MAYCAT_35KV_SECTION } from "../../config/TuDienNguyenLieuConfig";
...
const MayCat35NguyenLieu: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        MAYCAT_35KV_SECTION.forEach(sec => {
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            Tủ máy cắt liên lạc 35kV Nguyên Liệu
                        </h1>
...
export default MayCat35NguyenLieu;