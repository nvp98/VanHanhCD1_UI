...
const BM_LBMT1LuyenCoc: React.FC = () => {
    ...
    const apiURL = baseURL + "/api/LocBuiMoiTruongMatDat1";
    ...
    const handleExportExcel = async () => {
        ...
        try {
            ...
            link.href = url;
            link.download = `BM.15/QT.05.07_NKVH_LBMTMatDat1_${fromStr}_đến_${toStr}.xlsx`;
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            Nhật ký vận hành Lọc Bụi Môi Trường Mặt Đất 1
                        </h1>
...
export default BM_LBMT1LuyenCoc;