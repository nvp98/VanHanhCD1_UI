...
import { LUYENCOC_QGTH1_SECTION } from "../../config/LuyenCocQGTH1";

type OutletContextType = { isSidebarOpen: boolean };


const BM_QGTH1LuyenCoc: React.FC = () => {
    const baseURL = import.meta.env.VITE_API_BASE_URL;
    const apiURL = baseURL + "/api/QuatTuanHoan1";
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            Nhật ký vận hành Quạt Tuần Hoàn CDQ1
                        </h1>
...
export default BM_QGTH1LuyenCoc;