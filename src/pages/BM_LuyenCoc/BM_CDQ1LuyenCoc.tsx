...
const BM_CDQ1LuyenCoc: React.FC = () => {
  const baseURL = import.meta.env.VITE_API_BASE_URL;
  const apiURL = baseURL + "/api/LuyenCocCDQ1";
  ...
  const handleExportExcel = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `BM.12/QT.05.07_NKVH_CDQ1_${fromStr}_đến_${toStr}.xlsx`;
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 relative">
          ...
          <div className="flex flex-col items-center gap-3">
            <h1 className="text-2xl font-bold text-gray-800 text-center">
              Nhật ký vận hành Luyện Cốc CDQ1
            </h1>
...
export default BM_CDQ1LuyenCoc;