...
const DongCoLocBuiNhaSang2LuyenCoc: React.FC = () => {
    ...
    useEffect(() => {
        fetch(`${baseURL}/api/LocBuiNhaSang2/last-24h`)
            .then(res => res.json())
            .then(data => {
                setDataRows(data);
    ...
    useEffect(() => {
        fetch(`${baseURL}/api/LocBuiNhaSang2/min-value`)
            .then(res => res.json())
            .then(data => {
                setTagMinValue(data);
    ...
    const handleSearch = async () => {
        ...
        try {
            const res = await fetch(`${baseURL}/api/LocBuiNhaSang2/search?from=${from}&to=${to}`);
    ...
    const handleExportExcel = async () => {
        ...
        try {
            const res = await fetch(`${baseURL}/api/LocBuiNhaSang2/export?from=${fromDate}&to=${toDate}`);
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        LUYENCOC_LB_NHASANG2_SECTION.forEach(sec => {
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            Động Cơ Lọc Bụi Nhà Sàng 2 Luyện Cốc
                        </h1>
...
export default DongCoLocBuiNhaSang2LuyenCoc;