                ...
                <div className="theme-swiss sm:m-6 sm:ml-10 space-y-10 h-full px-6  pt-4 pb-20 bg-white " >
                        ...
                        <div >
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                                        ...
                                        <ComponentEquipment primary title="1. Động cơ băng tải trung thế" to="" />
                                </div>
                        </div>
                        <div >
                                <h2 className="text-sm font-extrabold text-skin-inverted sm:text-sm">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                                        ...
                                        <ComponentEquipment primary title="1. Lọc bụi C1" to="" />
                                        <ComponentEquipment primary title="2. Lọc bụi C2" to="" />
                                        <ComponentEquipment primary title="3. Lọc bụi C3" to="" />
                                        <ComponentEquipment primary title="4. Lọc bụi C4" to="" />
                                        <ComponentEquipment primary title="5. Lọc bụi C5" to="" />
                                </div>
                        </div>
                </div>
        )
