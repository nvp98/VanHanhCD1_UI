                ...
                if (row.children && Array.isArray(row.children)) {
                            ...
                            >
                                ...
                                {index === 0 && (
                                    <td
                                        ...
                                        className="sticky left-[8.8rem] bg-white border px-2 py-1 font-semibold align-middle whitespace-pre-line"
                                    >
                                        {row.label}
                                    </td>
                                )}
                    ...
                    rows.push(
                        ...
                        >
                            ...
                            <td
                                className="sticky left-[8.8rem] bg-white font-semibold border px-2 py-1"
                                colSpan={2}
                            >
                                {row.label}
                            </td>
