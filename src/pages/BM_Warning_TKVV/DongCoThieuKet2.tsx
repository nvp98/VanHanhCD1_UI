...
import { DONGCOTHIEUKET2_CONFIG, DONGCOTHIEUKET2_SECTION } from "../../config/DongCoThieuKet2Config";
...
const DongCoThieuKet2: React.FC = () => {
    ...
    const handleSearch = async () => {
        ...
        try {
            const res = await fetch(`${baseURL}/api/DongCoThieuKet2/search?from=${from}&to=${to}`);
    ...
    const handleExportExcel = async () => {
        ...
        try {
            const res = await fetch(`${baseURL}/api/DongCoThieuKet2/export?from=${fromDate}&to=${toDate}`);
