        ...
        for (const time of dataColumns) {
            ...
            if (isNguyeHiem) {
                ...
                const payload: WarningHistoryConfig = {
                    thoiGian: time,
                    tagName: tag,
                    khuVuc: "Phụ trợ Quạt Gió 1", // chỉnh theo logic của bạn
                    tenThongSo: tagName,
                    giaTri: Number(value),
                    trangThai: 2,
                    donVi: tagUnit
                    ...
                    <table className="min-w-full table-auto text-sm border-separate border border-gray-300 bg-white">
                        <thead className="bg-gray-100 text-gray-800 text-center sticky top-0 z-20">
                            <tr>
                                ...
                                <th className="border px-4 py-2 sticky left-[26rem] z-30 bg-gray-100 whitespace-nowrap whitespace-nowrap">Cảnh báo</th>
                                <th className="border px-4 py-2 sticky left-[32rem] z-30 bg-gray-100 whitespace-nowrap whitespace-nowrap">Nguy hiểm</th>
