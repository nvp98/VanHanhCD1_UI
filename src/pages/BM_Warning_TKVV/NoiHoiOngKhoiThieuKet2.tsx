...
const NoiHoiOngKhoiThieuKet2: React.FC = () => {
    ...
    const handleSearch = async () => {
        ...
        try {
            const res = await fetch(`${baseURL}/api/NoiHoiOngKhoiHai/search?from=${from}&to=${to}`);
    ...
    const handleExportExcel = async () => {
        ...
        try {
            const res = await fetch(`${baseURL}/api/NoiHoiOngKhoiHai/export?from=${fromDate}&to=${toDate}`);
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 relative">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-2xl font-bold text-gray-800 text-center">
                            Nồi Hơi Ống Khói Và Quạt Gió Làm Mát Vòng #2
                        </h1>
