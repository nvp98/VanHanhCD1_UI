...
import { LOVOIQUAY_CONFIG, LOVOIQUAY_SECTION } from "../../config/LoVoiQuay";
...
const DongCoLoVoiQuay: React.FC = () => {
...
export default DongCoLoVoiQuay;