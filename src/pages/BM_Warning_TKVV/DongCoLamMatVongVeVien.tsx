...
import { LAMMATVONG_VEVIEN_CONFIG, LAMMATVONG_VEVIEN_SECTION } from "../../config/LamMatVongVeVienConfig";
...
const DongCoLamMatVongVeVien: React.FC = () => {
    ...
    useEffect(() => {
        fetch("/TagWarning.xlsx")
            ...
            .then(buffer => {
                ...
                const sheet = workbook.Sheets[workbook.SheetNames[16]];
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        LAMMATVONG_VEVIEN_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={LAMMATVONG_VEVIEN_CONFIG}
                />}
...
export default DongCoLamMatVongVeVien;