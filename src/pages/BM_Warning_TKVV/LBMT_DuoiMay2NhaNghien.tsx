...
const LBMT_DuoiMayHaiNhaNghien: React.FC = () => {
    ...
    const renderTagCellWithData = (label: string) => {
        ...
        const rowCells = [
            ...
            <td key={`${label}-value`} className="sticky left-[16.8rem] bg-white border px-2 py-1 text-xs">{values}</td>,
                    ...
                    <table className="min-w-full table-auto text-sm border-collapse border border-gray-300 bg-white">
                        <thead className="bg-gray-100 text-gray-800 text-center sticky top-0 z-20">
                            <tr>
                                ...
                                <th className="border px-4 py-2 sticky left-[12rem] z-30 bg-gray-100 whitespace-nowrap">Đơn Vị</th>
                                <th className="border px-4 py-2 sticky left-[16.8rem] z-30 bg-gray-100  whitespace-nowrap">MIN 3 Tháng</th>
