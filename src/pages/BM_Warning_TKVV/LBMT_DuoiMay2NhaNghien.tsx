...
import {
  DUOIMAYNHANGHIEN_CONFIG,
  DUOIMAY2_SECTION,
  NHANGHIEN_SECTION,
} from "../../config/LBMTDuoiMay2NhaNghienConfig";
...
const LBMT_DuoiMayHaiNhaNghien: React.FC = () => {
  const baseURL = import.meta.env.VITE_API_BASE_URL;
  const apiURL = baseURL + "/api/LocBuiMoiTruongDuoiMayHai";
  ...
  const renderTagCellWithData = (label: string) => {
    ...
    const rowCells = [
      <td
        key={`${label}-symbol`}
        className="sticky left-[12rem] bg-white border px-2 py-1 text-xs"
      >
        {display}
      </td>,
      <td
        key={`${label}`}
        className="sticky left-[16.8rem] bg-white border px-2 py-1 text-xs"
      >
        {values}
      </td>,
      <td
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 relative">
          ...
          <div className="flex flex-col items-center gap-3">
            <h1 className="text-2xl font-bold text-gray-800 text-center">
              Lọc Bụi Môi Trường Đuôi Máy 2 & Nhà Nghiền
            </h1>
            ...
            <table className="min-w-full table-auto text-sm border-collapse border border-gray-300 bg-white">
              <thead className="bg-gray-100 text-gray-800 text-center sticky top-0 z-20">
                <tr>
                  ...
                  <th className="border px-4 py-2 sticky left-[12rem] z-30 bg-gray-100 whitespace-nowrap">
                    Đơn Vị
                  </th>
                  <th className="border px-4 py-2 sticky left-[16.8rem] z-30 bg-gray-100  whitespace-nowrap">
                    MIN 3 Tháng
                  </th>
              ...
              <tbody className="text-gray-800 even:bg-gray-50">
                {renderNestedRows(DUOIMAY2_SECTION, "Đuôi Máy 2")}
                {renderNestedRows(NHANGHIEN_SECTION, "Nhà Nghiền")}
              </tbody>
            </table>
          </div>
        )}
...
export default LBMT_DuoiMayHaiNhaNghien;
