...
import { DONGCO_THANHPHAM_VOI_CONFIG, DONGCO_THANHPHAM_VOI_SECTION } from "../../config/DongCoThanhPhamVoiConfig";
...
const DongCoThanhPhamVoi: React.FC = () => {
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        DONGCO_THANHPHAM_VOI_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={DONGCO_THANHPHAM_VOI_CONFIG}
                />}
...
export default DongCoThanhPhamVoi;