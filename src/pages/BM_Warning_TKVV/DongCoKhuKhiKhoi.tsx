...
import { DONGCOKHUKHIKHOI_CONFIG, DONGCOKHUKHIKHOI_SECTION } from "../../config/DongCoKhuKhiKhoiConfig";
...
const DongCoKhuKhiKhoi: React.FC = () => {
    const baseURL = import.meta.env.VITE_API_BASE_URL;
    const apiURL = baseURL + "/api/DongCoKhuKhiKhoi";
    ...
    useEffect(() => {
        fetch("/TagWarning.xlsx")
            ...
            .then(buffer => {
                ...
                const sheet = workbook.Sheets[workbook.SheetNames[17]];
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        DONGCOKHUKHIKHOI_SECTION.forEach(sec => {
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow ring-1 ring-gray-200 p-6 space-y-6">
                ...
                {visible.chart && <FlowDashboardChart
                    rawData={dataRows}
                    TAG_CONFIG={DONGCOKHUKHIKHOI_CONFIG}
                />}
...
export default DongCoKhuKhiKhoi;