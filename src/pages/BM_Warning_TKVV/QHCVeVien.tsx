...
import { QGCVEVIEN_CONFIG, QGCVEVIEN_SECTION } from "../../config/QGCVeVienConfig";
...
const QHCVeVien: React.FC = () => {
    ...
    const handleSearch = async () => {
        ...
        try {
            const res = await fetch(`${baseURL}/api/QHCVeVien/search?from=${from}&to=${to}`);
    ...
    const handleExportExcel = async () => {
        ...
        try {
            const res = await fetch(`${baseURL}/api/QHCVeVien/export?from=${fromDate}&to=${toDate}`);
                    ...
                    row.children.forEach((label, index) => {
                        ...
                        rows.push(
                            ...
                            >
                                ...
                                <td className="sticky left-[12.4rem] bg-white border px-2 py-1">{label}</td>
                                {renderTagCellWithData(tag)}
                            </tr>
                        );
                    ...
                    <table className="min-w-full table-auto text-sm border-collapse border border-gray-300 bg-white">
                        <thead className="bg-gray-100 text-gray-800 text-center sticky top-0 z-20">
                            <tr>
                                ...
                                <th className="border px-4 py-2 sticky left-[13.5rem] z-30 bg-gray-100 whitespace-nowrap">Đơn Vị</th>
                                ...
                                <th className="border px-4 py-2 sticky left-[29rem] z-30 bg-gray-100 whitespace-nowrap">Nguy hiểm</th>                                {/* th time */}
