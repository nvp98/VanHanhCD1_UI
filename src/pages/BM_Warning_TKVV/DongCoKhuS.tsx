...
import { DONGCOKHUS_CONFIG, DONGCOKHUS_SECTION } from "../../config/DongCoKhuSConfig";
...
const DongCoKhuS: React.FC = () => {
    const baseURL = import.meta.env.VITE_API_BASE_URL;
    const apiURL = baseURL + "/api/DongCoKhuS";
    ...
    useEffect(() => {
        fetch("/TagWarning.xlsx")
            ...
            .then(buffer => {
                ...
                const sheet = workbook.Sheets[workbook.SheetNames[18]];
    ...
    const renderNestedRows = (): React.ReactNode[] => {
        ...
        DONGCOKHUS_SECTION.forEach(sec => {
