...
import { LOCBUIC1_SECTION} from "../../config/BaiLieuDongCoLocBui";

type OutletContextType = { isSidebarOpen: boolean };

const BM_LocBuiC1: React.FC = () => {
    ...
    const handleExportExcel = async () => {
        ...
        try {
            ...
            link.href = url;
            link.download = `BM.01/HD.05.60-19_NKVH_Lọc Bụi C1_${fromStr}_đến_${toStr}.xlsx`;
