...
import { LOCBUIC3_SECTION,  LOCBUIC3_CONFIG} from "../../config/BaiLieuDongCoLocBui";
...
const DongCoLocBuiC3: React.FC = () => {
    ...
    useEffect(() => {
        fetch(`${baseURL}/api/LocBuiC3/min-value`)
            .then(res => res.json())
            .then(data => {
                setTagMinValue(data);
