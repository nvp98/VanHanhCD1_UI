...
import { LOCBUIC4_SECTION,  LOCBUIC4_CONFIG} from "../../config/BaiLieuDongCoLocBui";
...
const DongCoLocBuiC4: React.FC = () => {
    ...
    useEffect(() => {
        fetch(`${baseURL}/api/LocBuiC4/min-value`)
            .then(res => res.json())
            .then(data => {
                setTagMinValue(data);
