...
import { LOCBUIC5_SECTION,  LOCBUIC5_CONFIG} from "../../config/BaiLieuDongCoLocBui";
...
const DongCoLocBuiC5: React.FC = () => {
    ...
    useEffect(() => {
        fetch(`${baseURL}/api/LocBuiC5/min-value`)
            .then(res => res.json())
            .then(data => {
                setTagMinValue(data);
