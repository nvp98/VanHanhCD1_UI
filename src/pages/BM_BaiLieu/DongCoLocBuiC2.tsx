...
import { LOCBUIC2_SECTION,  LOCBUIC2_CONFIG} from "../../config/BaiLieuDongCoLocBui";
...
const DongCoLocBuiC2: React.FC = () => {
    ...
    useEffect(() => {
        fetch(`${baseURL}/api/LocBuiC2/min-value`)
            .then(res => res.json())
            .then(data => {
                setTagMinValue(data);
